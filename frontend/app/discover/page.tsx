                    ...
                    <div key={item.id} className="group">
                      <Card className="overflow-hidden h-full hover:shadow-md transition-shadow">
                        ...
                        <CardFooter className="px-4 py-3 border-t bg-muted/50 flex flex-col gap-2">
                          ...
                          <Link href={`/chat/${item.sellerId}?itemId=${item.id}&itemType=product&title=${encodeURIComponent(item.title)}`} 
                            className="w-full">
                    ...
                    <div key={service.id} className="group">
                      <Card className="overflow-hidden h-full hover:shadow-md transition-shadow">
                        ...
                        <CardFooter className="px-4 py-3 border-t bg-muted/50 flex flex-col gap-2">
                          ...
                          <Link href={`/chat/${service.sellerId}?itemId=${service.id}&itemType=service&title=${encodeURIComponent(service.title)}`} 
                            className="w-full">
                            <Button variant="outline" size="sm" className="w-full">
                              <MessageCircle className="h-4 w-4 mr-2" />
                              Chat with Seller
